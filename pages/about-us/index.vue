  ...
  <div>
    ...
    >
      <div class="flex justify-between items-start gap-22 xl:gap-44 animate-fade-in-down-mob">
        ...
        <img
          :src="require('~/assets/img/about-us-draw.svg')"
          alt="About us"
...
export default {
  ...
  data: () => ({
    about:
      'Stutor is a platform that offers alternative ways of learning for classes. The purpose of stutor is to make it more accessible to find other students that could help you out with specific courses. Stutor also offers a way for students to make some extra money in return for their time spent helping other students.',
    partners:
    ...
    team: [
      {
        ...
        pic: 'maurits.jpeg',
        linkedIn: 'https://www.linkedin.com/in/maurits-arissen-abb09b16b/',
      ...
      },
      {
        ...
        name: 'Lucas Felicio',
        pic: 'lucas.jpeg',
        linkedIn: 'https://www.linkedin.com/in/lucas-goncalves-felicio-b80794136/',
        role: 'Creative Business, Blockchain Ecosystem development',
      },
      {
        id: 3,
        name: 'Daan Franssen',
        ...
        role: 'Accountant, Compliance, Finance, Scrum Master',
      },
      {
        id: 4,
      ...
      },
      {
        ...
        pic: 'bart.jpeg',
        linkedIn: 'https://www.linkedin.com/in/bart-van-tongeren-168214b4/',
